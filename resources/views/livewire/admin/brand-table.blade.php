<div>
    <div class="w-full flex pb-10">
        <div class="w-1/6 mx-1 relative">
            <input wire:model.debounce.300ms="search" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4" placeholder="Search brands...">
        </div>
        <div class="w-1/6 mx-1 relative">
    ...
    @if(!empty($brands))
        <table class="table-auto w-full mb-6">
            ...
            <tr>
                ...
                <a href="{{ route('admin.brands.edit', $brand->id) }}"><button class="text-white bg-yellow-600 hover:bg-yellow-900 px-2">Edit</button></a>
