<div>
    <div class="w-full flex pb-10">
        <div class="w-1/6 mx-1 relative">
            <input wire:model.debounce.300ms="search" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4" placeholder="Search Products...">
        </div>
        <div class="w-1/6 mx-1 relative">
        ...
        <table class="table-auto w-full mb-6">
            ...
            <tr>
                ...
                <td class="border px-4 py-2">{{ $product->price }}
                 ...
                 <td class="border px-4 py-2">{{ $product->status }}
                </td>
